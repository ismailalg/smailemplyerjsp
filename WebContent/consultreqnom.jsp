...
<jsp:setProperty property="*" name="ee"/><br><br><br><br>
...
<tbody>
<%List<employer> l=employerdao.gettablenom(ee); %>
<% for(employer eee:l){   %>
<tr class="info">
<td><%= eee.getId() %></td>
...
<td><a href=" observation.jsp?id=<%= eee.getId() %>">observe</a></td>
