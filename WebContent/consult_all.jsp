...
<a href="statistique_intervenant.jsp"   type="button" class="btn btn-warning btn-md">statistique</a>
</form>
...
<%ArrayList<employer>l=new ArrayList<>(employerdao.consult_all(d, dtr)); %>
...
<td  ><%= eee.getIntervenant() %></td>
<td  ><%= eee.getNbr_intervention() %></td>
