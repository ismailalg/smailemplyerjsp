...
<marquee behavior="scroll"  loop="-6" width="100%" height="50"  bgcolor=	#99ffff ><p style="color:blue;font-family:verdana;font-size:200%">Bienvenue Au Departement  Informatique CBR BATNA /Intervention </p>.</marquee>
